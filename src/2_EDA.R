...
# Lectura ----
tradicional <- read_csv("./data/2_interim/delitos_tradicional.csv")
control <- read_csv("./data/2_interim/delitos_control.csv")
oral <- read_csv("./data/2_interim/delitos_oral.csv")
